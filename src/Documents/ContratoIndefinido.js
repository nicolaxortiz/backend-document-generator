    ...
    content: [
...

      {
        text: [
          ...
          {
            text: ` Duración del contrato. La duración del presente contrato es indefinida. Para tales efectos, inicia a regir desde la fecha ${empl.startDate} y permanecerá vigente mientras subsistan las causas que le dieron origen, salvo que de común acuerdo las partes consientan en darlo por terminarlo, o se incurra en alguna de las situaciones de ley que permitan la terminación unilateral del mismo.`,
          },
        ],
        margin: [0, 0, 0, 10],
      },
